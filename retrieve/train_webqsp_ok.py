...
from src.dataset.retriever import RetrieverDataset, collate_retriever, OptimizedRetrieverDataset, collate_retriever_batch
...
def main(args):
    ...
    if args.dataset == 'cwq':
        ...
        default_samples_per_epoch = 20000
        default_samples_per_batch_load = 128
        default_batch_size = 1
        default_num_workers = 0
...
if __name__ == '__main__':
    ...
    parser.add_argument('--samples_per_batch_load', type=int, default=None,
    ...
    print(f"Retriever training time: {end_time - start_time}")