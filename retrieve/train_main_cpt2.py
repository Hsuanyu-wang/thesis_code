...
def main(args):
    ...
    train_set = RetrieverDataset(config=config, split='train', freq_weight=args.freq_weight, freq_weight_inv=args.freq_weight_inv)
    val_set = RetrieverDataset(config=config, split='val', freq_weight=args.freq_weight, freq_weight_inv=args.freq_weight_inv)
